...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CMU_HFXO_FREQ, 39000000);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CMU_LFXO_FREQ, 32768);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_FLASH_SIZE, 1536);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_SILABS_GECKO_SEMAILBOX_ENABLED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_SILABS_GECKO_STIMER_ENABLED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_SILABS_GECKO_USART_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_SILABS_SERIES2_HFRCOEM23_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_HAS_SILABS_GECKO, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_XG24_EK2703ATEST, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_XG24_EK2703ATEST_EFR32MG24B220F1536IM48, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_SERIES_EFR32MG24, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_PART_NUMBER_EFR32MG24B220F1536IM48, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_GECKO_SDID, 215);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_GECKO_I2C, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CMU_HFCLK_HFXO, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_I2C_GECKO, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_UART_GECKO, 1);
